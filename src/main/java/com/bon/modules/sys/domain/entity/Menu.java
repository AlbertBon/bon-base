...
public class Menu implements Serializable {
    ...
    public Menu(Long menuId, Date gmtCreate, Date gmtModified, String name, String path, String component, String redirect, String title, String icon, String hidden, String alwaysShow) {
        this.menuId = menuId;
